...
namespace Acq5._12
{
    public partial class Form1 : Form
    {
        ...
        private void mesure()
        {
            ...
            System.Drawing.Pen pen1 = new System.Drawing.Pen(Color.Red, 1F);
        ...
        public static void save()
        {
            ...
            string[] csv = new string[sampleCount];
            for (int i = 0; i < sampleCount; i++)
            {
                csv[i] = wynikipomiarow[i];
                
            }
            System.IO.File.WriteAllLines(FILE_NAME, csv);
        }
